  ...
  return (
    <div className="w-full flex flex-col items-center pt-10 min-h-screen">
      ...
      <div className="relative flex items-center justify-between md:w-[50%] mb-8">
        <div className="absolute top-[25%] left-0 w-[80%] md:w-[85%] h-1 bg-slate-400 -z-10" />
        {[1, 2, 3].map((step) => (
          <div key={step}>
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold ${
                step <= activeStep ? "bg-green-500" : "bg-gray-400"
              }`}
            >
              {step}
            </div>
      ...
      <div className="w-full py-10 min-h-screen bg-[#f1f1f1] flex items-center justify-center">
        {/* Steps content */}
                ...
                {!showOtp ? (
                  ...
                  >
                    ...
                    <p className="text-center text-sm text-gray-500 mt-1">
                      Sign up to create an account and start your online store.
                    </p>
                    {/* Name */}
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        {...register("phone", {
                          ...
                          pattern: {
                            value: /^\+?[1-9]\d{1,14}$/, //Following E.164 format
